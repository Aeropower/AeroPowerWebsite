...
const SponsorshipTiers = () => (
  <section className="py-20 bg-gray-50 shadow-shadow-md">
    <div className="container mx-auto px-4">
      <h2 className="text-3xl font-bold text-center mb-16 text-gray-900">Sponsorship Opportunities</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {Object.entries(tiers).map(([key, tier]) => (
          <div key={key} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-hard transition-shadow">
